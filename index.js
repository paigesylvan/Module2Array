...
function getFlavorByIndex(originalFlavors){
  return originalFlavors [8];
}
console.log("task 5:", getFlavorByIndex(originalFlavors, 8));
...
function removeFlavorByName(originalFlavors, BlackWalnut){
  for(let i = 0; i < originalFlavors.length; i++){
    if(originalFlavors[i] === "Black Walnut"){
